  ...
  return (
    <>
      ...
      <button
        ...
        onClick={toggle}
        className={cn(
          "px-4 h-9 bg-muted text-muted-foreground border border-border flex items-center justify-center gap-2 rounded-full cursor-pointer outline-none hover:bg-muted/50 transition-colors",
          className
        )}
