...
import { SectionWrapper } from "../section-wrapper"; // 👈 استدعاء الـ Wrapper
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
        {projects.map((project, i) => (
          <motion.div
            ...
            className="group relative flex flex-col justify-between p-6 md:p-8 rounded-[1.5rem] border border-border/50 bg-card hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5 transition-all duration-300 ease-out"
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-[95%] mb-6 transition-colors duration-300">
                {project.description}
              </p>
            </div>
