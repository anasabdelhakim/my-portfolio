        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left justify-start px-3 sm:px-6 lg:pl-12 lg:pr-4 pt-12 w-full">
          ...
          >
            ...
            <a
              ...
              className="w-full sm:w-auto group relative flex items-center justify-center gap-2 h-12 px-8 rounded-full border-2 border-border  backdrop-blur-md text-foreground text-[13px] uppercase tracking-[1.5px] transition-[letter-spacing,background-color,border-color,color,box-shadow] duration-300 ease-out hover:tracking-[3px] hover:bg-[#7C3AED] hover:border-[#7C3AED] hover:text-white hover:shadow-[0_7px_20px_0_rgba(124,58,237,0.3)] active:translate-y-[1px] active:scale-[0.99] active:shadow-none active:duration-75 z-10"
            >
